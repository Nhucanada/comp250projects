...
public class Deck3 {
	...
	public int numOfCards; // contains the total number of cards in the Deck3
	public Card head; // contains a pointer to the card on the top of the Deck3

	/*
	 * TODO: Initializes a Deck3 object using the inputs provided
	 */
	...
	/*
	 * TODO: Implements a copy constructor for Deck3 using Card.getCopy().
	 * This method runs in O(n), where n is the number of cards in d.
	 */
	public Deck3(Deck3 d) {
	...
	/*
	 * TODO: Adds the specified card at the bottom of the Deck3. This
	 * method runs in $O(1)$.
	 */
	...
	/*
	 * TODO: Shuffles the Deck3 using the algorithm described in the pdf.
	 * This method runs in O(n) and uses O(n) space, where n is the total
	 * number of cards in the Deck3.
	 */
	public void shuffle() {

		Card[] cards = new Card[numOfCards];
		Card currentCard = head;
		Deck3 shuffledDeck3 = new Deck3();
		...
		for(int m = 0; m < numOfCards; m++){
			...
			shuffledDeck3.addCard(cards[m]);

		}

		head = shuffledDeck3.head;

	}

	/*
	 * TODO: Returns a reference to the joker with the specified color in
	 * the Deck3. This method runs in O(n), where n is the total number of
	 * cards in the Deck3.
	 */
	...
	/*
	 * TODO: Moved the specified Card, p positions down the Deck3. You can
	 * assume that the input Card does belong to the Deck3 (hence the Deck3 is
	...
	/*
	 * TODO: Performs a triple cut on the Deck3 using the two input cards. You
	 * can assume that the input cards belong to the Deck3 and the first one is
	 * nearest to the top of the Deck3. This method runs in O(1)
	 */
	...
	/*
	 * TODO: Performs a count cut on the Deck3. Note that if the value of the
	 * bottom card is equal to a multiple of the number of cards in the Deck3,
	 ...
	 * card on the top of the Deck3, and counting down that many cards. If the
	 ...
	 * using this Deck3. This method runs in O(n).
	 */
